...
<div class="min-h-screen py-8 bg-gray-50 dark:bg-gray-900">
    <div class="max-w-md px-4 mx-auto sm:px-6 lg:px-8">
        <div class="mb-8">
            <h1 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Create Tag</h1>
            <p class="text-gray-600 dark:text-gray-400">Add a new tag for organizing posts</p>
        </div>
